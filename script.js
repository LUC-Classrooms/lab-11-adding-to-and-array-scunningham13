...
*/
var dots = new Array(1); //creates an empty array with one space

function setup() { //set up the sketch
  createCanvas(500, 300); //set up size of canvas
...
function draw() {
  ...
  textSize(24);
  fill(100, 0, 200);
  text("'dots' array length: " + dots.length, 100, 100); //display size of array on screen
